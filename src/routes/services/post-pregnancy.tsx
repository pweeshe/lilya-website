...
export const Route = createFileRoute('/services/post-pregnancy')(
  {
...
function RouteComponent() {
  return <div className="flex pt-24 flex-row gap-8 px-8 max-w-[1600px] mx-auto pb-16">
    <aside className="sticky top-24 self-start">
      <ServicesSideMenu />
    </aside>
    <section className="flex-1 w-full max-w-[800px]">
      <img 
